...
void	Server::register_clients(void)
{
	...
	while (i < _clients.size() && _clients_to_auth)
	{
		...
		if (_clients[i]._register(_client_nicks))
		{
			...
			_clients_to_auth--;
			msg = ":42.irc.my.server 001 " + nick_name + " :Welcome " + nick_name + "\r\n";
			msg += ":42.irc.my.server 002 " + nick_name + " :Your host is 42_IRC, running version 0.1" + "\r\n";
			msg += ":42.irc.my.server 003 " + nick_name + " :This server was created " + _time_str + "\r\n";
			msg += ":42.irc.my.server 004 " + nick_name + " 42_IRC 0.1\r\n";
			msg += ":42.irc.my.server 005 " + nick_name + " CASEMAPPING=ascii "
